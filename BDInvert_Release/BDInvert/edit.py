...
def main():
    ...
    direction_basename = os.path.splitext(os.path.basename(args.edit_direction))[0]
    # Get GAN type
    ...
    for sam_id in tqdm(range(len(image_list)), leave=False):
        ...
        for col_id, d in enumerate(distances, start=1):
            ...
            cv2.imwrite(os.path.join(inversion_dir, f'edited', f'{image_list[sam_id]}_{direction_basename}_{col_id}.png'), image)
